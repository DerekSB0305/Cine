      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div class="p-4">
            ...
            <form action="/horario/{{$movie->id}}" method="get">
            @csrf
            <div class="text-center">
              <button  class="bg-blue-600 text-white px-6 py-3 rounded-lg font-medium shadow-md hover:bg-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                Horario
              </button>
            </div>
            </form>
